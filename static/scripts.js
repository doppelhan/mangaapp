...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ฟังก์ชันสำหรับการประมวลผลภาพทันทีหลังการอัปโหลด
    function uploadAndProcessImage(formData) {
        fetch('/', {
            method: 'POST',
            body: formData
        })
